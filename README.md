...
BDencode.py - An encoding/organizing task manager with simple GUI. Handles vpy generation, audio encoding, ass fonts subseting and so on.

pgs_ass_color.py - A script coloring Ass subtitles base on PGS subs.
```
